...
def ingest(
    *,
    ...
    # B1.5.4 - one citation-ledger source_id shared across all rbi_xlsx
    # specs (same State Finances publication / edition per ADR-0042).
    ...
    for spec in specs:
        ...
        # B1.5.4 - canonical long-format CSV emission ALONGSIDE the
