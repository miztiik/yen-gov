"""One-off driver for B2b.4.2: emit ``datasets/data/facet_axes.csv`` from
the surviving ``datasets/taxonomy/facet-axes.parquet``. Run from repo root.
"""
...
def main() -> None:
    ...
    out_path = repo_root / "datasets" / "data" / "facet_axes.csv"
