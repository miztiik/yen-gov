...
side is in :mod:`yen_gov.canonical.adapters.iced_air_quality.ingest`; the network
boundary is :class:`IcedClient` in :mod:`yen_gov.canonical.adapters.iced_common`.
"""
...
from yen_gov.canonical.adapters.iced_common import ENTITY_MAP, ICEDShapeError
...
def extract_state_rows(decrypted: dict[str, Any]) -> list[ParsedRow]:
    ...
    :data:`yen_gov.canonical.adapters.iced_common.ENTITY_MAP`. An unknown spelling
