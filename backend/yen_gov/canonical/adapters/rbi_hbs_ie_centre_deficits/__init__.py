...
Sibling-by-shape of :mod:`yen_gov.canonical.adapters.rbi_appendix_deficits` (which
...
(:func:`yen_gov.canonical.adapters.rbi_appendix_deficits.parsers.parse_workbook`)
