...
:mod:`yen_gov.canonical.adapters.datagovin_ogd.pincode_polygons`), cross-joins
...
Invocation::
    ...
    python -m yen_gov.canonical.adapters.datagovin_ogd.ingest_pincode_polygons
"""
...
def _ECI_TO_LGD_SLUG() -> dict[str, str]:
    ...
    if _ECI_TO_LGD_SLUG_CACHE is None:
        ...
        # parents: [0]=datagovin_ogd [1]=adapters [2]=canonical [3]=yen_gov [4]=backend [5]=repo root
