...
def render_markdown(report: CoverageReport) -> str:
    ...
    out.append(
        ...
        "Re-run after every election ingest. Canonical indicator inventory "
        "lives in [`datasets/data/variables.csv`](../../datasets/data/variables.csv) "
        "and [`datasets/data/datapoints/`](../../datasets/data/datapoints/); "
        "this report covers election catalogue and on-disk election coverage. "
        "The declared election catalogue lives at "
    ...
    if not report.indicators:
        out.append(
            "_Indicator inventory is canonical CSV now; use "
            "`datasets/data/variables.csv`, `datasets/data/datapoints/`, "
            "and [data-coverage-report.md](data-coverage-report.md)._"
        )
        out.append("")
    else:
        wiring_known = any(
