...
# ---------------------------------------------------------------------------
# C4.5 parity oracle — installed-capacity-snapshot-mw-{fuel}
#
...
def test_c45_snapshot_coal_in_s24_2026() -> None:
    """installed-capacity-snapshot-mw-coal, IN-S24 2026-03 = 25550.906."""
    val = _query_value("IN-S24", 2026, "installed-capacity-snapshot-mw-coal")
...
def test_c45_snapshot_coal_in_s13_2026() -> None:
    """installed-capacity-snapshot-mw-coal, IN-S13 2026-03 = 24714.238."""
    val = _query_value("IN-S13", 2026, "installed-capacity-snapshot-mw-coal")
...
def test_c45_snapshot_coal_in_s06_2026() -> None:
    """installed-capacity-snapshot-mw-coal, IN-S06 2026-03 = 16735.582."""
    val = _query_value("IN-S06", 2026, "installed-capacity-snapshot-mw-coal")
...
def test_c45_snapshot_gas_in_s06_2026() -> None:
    """installed-capacity-snapshot-mw-gas, IN-S06 2026-03 = 5615.72."""
    val = _query_value("IN-S06", 2026, "installed-capacity-snapshot-mw-gas")
...
def test_c45_snapshot_gas_in_s13_2026() -> None:
    """installed-capacity-snapshot-mw-gas, IN-S13 2026-03 = 3124.73."""
    val = _query_value("IN-S13", 2026, "installed-capacity-snapshot-mw-gas")
...
def test_c45_snapshot_gas_in_u05_2026() -> None:
    """installed-capacity-snapshot-mw-gas, IN-U05 2026-03 = 2007.414434."""
    val = _query_value("IN-U05", 2026, "installed-capacity-snapshot-mw-gas")
...
def test_c45_snapshot_hydro_in_s19_2026() -> None:
    """installed-capacity-snapshot-mw-hydro, IN-S19 2026-03 = 3827.435354."""
    val = _query_value("IN-S19", 2026, "installed-capacity-snapshot-mw-hydro")
...
def test_c45_snapshot_hydro_in_s08_2026() -> None:
    """installed-capacity-snapshot-mw-hydro, IN-S08 2026-03 = 3706.8698620."""
    val = _query_value("IN-S08", 2026, "installed-capacity-snapshot-mw-hydro")
...
def test_c45_snapshot_hydro_in_s24_2026() -> None:
    """installed-capacity-snapshot-mw-hydro, IN-S24 2026-03 = 3652.222272."""
    val = _query_value("IN-S24", 2026, "installed-capacity-snapshot-mw-hydro")
...
def test_c45_snapshot_nuclear_in_s22_2026() -> None:
    """installed-capacity-snapshot-mw-nuclear, IN-S22 2026-03 = 1448.0."""
    val = _query_value("IN-S22", 2026, "installed-capacity-snapshot-mw-nuclear")
...
def test_c45_snapshot_nuclear_in_s13_2026() -> None:
    """installed-capacity-snapshot-mw-nuclear, IN-S13 2026-03 = 1068.66."""
    val = _query_value("IN-S13", 2026, "installed-capacity-snapshot-mw-nuclear")
...
def test_c45_snapshot_nuclear_in_s06_2026() -> None:
    """installed-capacity-snapshot-mw-nuclear, IN-S06 2026-03 = 1034.89."""
    val = _query_value("IN-S06", 2026, "installed-capacity-snapshot-mw-nuclear")
...
def test_c45_snapshot_renewable_in_s20_2026() -> None:
    """installed-capacity-snapshot-mw-renewable, IN-S20 2026-03 = 46608.04."""
    val = _query_value("IN-S20", 2026, "installed-capacity-snapshot-mw-renewable")
...
def test_c45_snapshot_renewable_in_s06_2026() -> None:
    """installed-capacity-snapshot-mw-renewable, IN-S06 2026-03 = 45188.33."""
    val = _query_value("IN-S06", 2026, "installed-capacity-snapshot-mw-renewable")
...
def test_c45_snapshot_renewable_in_s13_2026() -> None:
    """installed-capacity-snapshot-mw-renewable, IN-S13 2026-03 = 28933.63."""
    val = _query_value("IN-S13", 2026, "installed-capacity-snapshot-mw-renewable")
...
def test_c45_snapshot_row_count_per_fuel_is_35() -> None:
    ...
    try:
        rows = con.execute(
            ...
            f"WHERE indicator_id LIKE 'installed-capacity-snapshot-mw-%' "
    ...
    expected = {
        f"installed-capacity-snapshot-mw-{fuel}": 35
