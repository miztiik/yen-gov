...
Phase C/D closure 2026-06-07: ``test_energy`` + ``test_livestock`` retired
in the same commit that ``git rm``'d the 9 energy + livestock parquets
(TODO/20260607-energy-livestock-csv-migration-subplan.md). Those tests
were the deletion-safety oracle for the parquets they validated; once
the parquets are gone, the oracle has no subject. The remaining tests
(``test_governments`` and any future family that ships parquets alongside
CSVs) keep the same shape and the same Holy Law #7 posture.
"""
