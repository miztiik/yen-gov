...
| P0a | Source + commit the 382-AC -> PC backfill crosswalk (geometric spatial join) | P0 / A | - | [x] DONE | #1234 | L |
| P0b | Wire crosswalk into the seed writer + regenerate `electoral.csv` | P0 / B | P0a | [x] DONE | #1235 | M |
