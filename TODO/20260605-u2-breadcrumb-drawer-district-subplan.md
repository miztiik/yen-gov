...
| U2b `GeoBreadcrumb.svelte` + integration into Home / StateOverview / StateTopic / Constituency / District | U2a | U2c, U4, U5 | build+vitest(breadcrumb)+in-browser smoke (5 routes) | _pending_ | IN-FLIGHT |
