...
| B2a entity+catalogue CSVs | B1 | U* | fk-validator | #_pending_ | MERGED (sub-plan archived at [docs/archive/plans/20260604-b2a-csv-catalogue-subplan.md](../docs/archive/plans/20260604-b2a-csv-catalogue-subplan.md); eight emits B2a.1=#673, B2a.2=#675, B2a.3=#677, B2a.4=#680, B2a.5=#678, B2a.6=#682, B2a.7=#684, B2a.8=#686, closure=#_pending_; distilled into [docs/architecture/backend/canonical-writer.md](../docs/architecture/backend/canonical-writer.md) section "Seed emitters") |
