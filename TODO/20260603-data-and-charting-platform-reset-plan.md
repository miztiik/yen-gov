...
| section 9 | Repo hygiene (ADR retire-keep-receipts, datasets/schemas/config/notes) | **ADR rule FINALIZED 2026-06-03 (Hans)**; `config/` row DONE 2026-06-08 (feat/g9-config-audit-and-prune): KEPT topojson + topojson-config schema, DELETED eci-pins + elections + processing + their 3 schemas + categories.py orphan reader + 3 ProcessingConfig pydantic classes, FOLDED-INLINE processing.results.* into cli.py constants; net = 1 file in `config/`; rest of §9 NOT STARTED |
