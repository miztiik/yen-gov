...
| U2 breadcrumb+drawer+district-url | U1 | B*, D* | build+visual | _pending_ | DEFERRED-TO-SUBPLAN ([TODO/20260605-u2-breadcrumb-drawer-district-subplan.md](20260605-u2-breadcrumb-drawer-district-subplan.md); four sub-rows U2a=url-builder+route+District / U2b=GeoBreadcrumb+integration / U2c=LeftRail re-cluster / U2d=closure) |
