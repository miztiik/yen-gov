...
| X1a-followup elections residuals (flip ac_crosswalk + parties-palette to CSV; delete DuckDbHarness; STOP-AND-SURFACE 3 election_results aggregators + dim_party_alliances + districts/states pending B2b emits + candidacies party_id resolution) | X1a | YA | dual-read-parity (extended) | _pending_ | IN-FLIGHT |
