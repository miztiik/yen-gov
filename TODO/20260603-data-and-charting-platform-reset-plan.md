...
| section 9 | Repo hygiene (ADR retire-keep-receipts, datasets/schemas/config/notes) | **ADR rule FINALIZED 2026-06-03 (Hans)**; ADR tier RETIRED 2026-06-05 (D-DOC3); `datasets/reference/` PARTIAL 2026-06-08 (G8: 5 files moved + pincode parquet->CSV per section 21.2, 165627 rows preserved; deprecation row in manifest; 32 constituencies.json + 6 lgd/*.csv DEFERRED). Rest (config/schemas/notes hygiene) NOT STARTED. |
