...
| F1 CSV loaders + oracle-rewrite | B2a, B2b, U1, D-DOC0 | U* | loader-unit+parity-oracle-CSV | #777, #791 (F1.1), #778 (F1.2), #803 (F1.3a), #806 (F1.3b), #??? (F1.4) | MERGED (sub-plan archived at [docs/archive/plans/20260605-f1-csv-loaders-and-oracle-rewrite-subplan.md](../docs/archive/plans/20260605-f1-csv-loaders-and-oracle-rewrite-subplan.md); seam distilled to data-loading.md + canonical-writer.md) |
