...
datasets/data/
  ...
  entities/state_codes.csv   # lgd_state_id (PK), lgd_name, iso_3166_2, kind, slug   (LGD-spine state identity; eci_st_code DROPPED - no authoritative ECI state-code registry exists, round-8)
  entities/state_aliases.csv # lgd_state_id, alias_kind, alias_value, valid_from, valid_to, source_id   (long-format validity-scoped aliases: name/former_name/iso/census2001/census2011/eci_st_code - round-8)
  entities/electoral.csv     # entity_id, name, aliases, entity_kind, delim_year, state, parent, eci_no, reservation, source_id   (LGD-native PK; eci_no folded; NO arithmetic ids - round-7)
...
| U5 skeleton+jump+doc+chartshell-states | U1 | B*, U3 | build | _pending_ | MERGED (sub-plan archived at [docs/archive/plans/20260605-u5-skeleton-jump-doc-chartshell-states-subplan.md](../docs/archive/plans/20260605-u5-skeleton-jump-doc-chartshell-states-subplan.md); spawn #751 + four sub-rows U5a=#752, U5a-stamp=#754, U5b=#755, U5c=#757, U5d=_pending_; distilled into [docs/architecture/frontend/design-system.md](../docs/architecture/frontend/design-system.md)) |
