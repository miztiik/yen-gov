...
| F1 CSV loaders + oracle-rewrite | B2a, B2b, U1, D-DOC0 | U* | loader-unit+parity-oracle-CSV | #777 | DEFERRED-TO-SUBPLAN ([TODO/20260605-f1-csv-loaders-and-oracle-rewrite-subplan.md](20260605-f1-csv-loaders-and-oracle-rewrite-subplan.md); four sub-rows F1.1=backend-oracle-rewrite, F1.2=frontend-loader-seam, F1.3=frontend-view-model-SQL-flip, F1.4=closure) |
| X1a reader flip | F1 | - | dual-read-parity | _pending_ | IN-FLIGHT |
