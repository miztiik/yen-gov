...
| D-DOC3 ADR-retire | - | all | grep-receipts-eq | #723 | DEFERRED-TO-SUBPLAN ([TODO/20260604-d-doc3-adr-retire-subplan.md](20260604-d-doc3-adr-retire-subplan.md); ten sub-rows D-DOC3.1=spawn / D-DOC3.2=redirect-index+baseline / D-DOC3.3=canonical-store-and-provenance ADRs / D-DOC3.4=indicator-naming-and-catalogue ADRs / D-DOC3.5=elections-and-electoral-hierarchy ADRs / D-DOC3.6=url-grammar-and-place-IA ADRs / D-DOC3.7=boundaries-and-map ADRs / D-DOC3.8=backend-ingest-and-schema ADRs / D-DOC3.9=yenask-and-misc ADRs / D-DOC3.10=CLAUDE.md-rewrite-and-decisions-dir-DELETE-and-closure) |
