...
datasets/data/
  ...
  entities/state_codes.csv   # state_slug, lgd_state_id, eci_st_code, iso_3166_2, census_2011_code, kind, aliases   (one-place LGD<->ECI<->ISO<->census map - round-7)
...
| U4 feasibleAt+switcher | D-DOC2 | B*, U3 | chart-drift-test | _pending_ | IN-FLIGHT |
