...
| YA1-YA3 | yen-ask re-point | IN-FLIGHT (semantic-catalogue startup queries flip to CSV + `fetchElectionEvents()` per Andre deviation; sentinel coercer for X1a-NULL'd source fields; YA2 model-runtime blockers parked) |
