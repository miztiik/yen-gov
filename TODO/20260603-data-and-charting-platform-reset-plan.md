...
| F2b new renderers (treemap/circlepack/choropleth/matrix) | F2a | F3,F4 | render-smoke | _pending_ | DEFERRED-TO-SUBPLAN ([TODO/20260606-f2b-new-renderers-subplan.md](20260606-f2b-new-renderers-subplan.md); eight sub-rows F2b.1=spawn (this PR), F2b.2=C2+C3+C5 primitives+color-scale.ts, F2b.3=GeoChoropleth{fill}, F2b.4=Matrix, F2b.5=Treemap, F2b.6=CirclePack{pack,bubble}, F2b.7=GeoChoropleth{symbol} mode extension, F2b.8=closure; user explicitly relaxed the `Blocks on X1b` edge in the F-track session brief - F-track is data-layer-agnostic and ships parallel-OK with X cutover; F2b builds on the U4-widened ChartType union + the F4-shipped d3-geo+topojson smoke + the F2a CategoryBar discriminated-union pattern) |
