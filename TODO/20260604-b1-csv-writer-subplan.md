...
| B1.6 ingest re-point wave 3 (`sources/cea_*`, `sources/datagovin_ogd`, `sources/india_geodata`, `pipeline/*`, `cli.py`, `canonical/adapters/eci_ae_panel.py`) | B1.2, B1.3 | suite-green | _pending_ | MERGED ([docs/archive/plans/20260604-b1.6-misc-repoint-subplan.md](../docs/archive/plans/20260604-b1.6-misc-repoint-subplan.md); seven family sub-rows B1.6.0..7 + B1.6.X closure) |
