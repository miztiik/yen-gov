...
| B1.4 ingest re-point wave 1 (`sources/iced_*`) | B1.2, B1.3 | suite-green | #_pending_ | MERGED (sub-plan archived at [docs/archive/plans/20260604-b1.4-iced-repoint-subplan.md](../docs/archive/plans/20260604-b1.4-iced-repoint-subplan.md); ten sub-rows B1.4.0..9 + B1.4.X shipped as PRs #634-#643 + closure) |
