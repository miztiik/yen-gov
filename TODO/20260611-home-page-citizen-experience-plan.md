...
| PR-4 | Doc lift: distill the deterministic-rotation rule + curated-5 pool + full-bleed shim into `docs/architecture/frontend/` | `[x] DONE (PR #pending)` | #pending | XS (~30 min) | PR-2 + PR-3 merged |
