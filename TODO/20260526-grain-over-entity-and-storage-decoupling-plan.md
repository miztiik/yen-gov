...
- PR-B3-batch8 _pending_ — strip `state-` prefix from final 10 state-* energy ids (electricity sales/req/avail per-capita + atc/acs-arr + coal/rooftop/renewable). 0 state-energy ids remaining post-merge.
