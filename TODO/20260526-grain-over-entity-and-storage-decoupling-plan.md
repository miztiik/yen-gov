...
**Status**: ▶ ACTIVE — PR-A1 ✅ PR #336; PR-A2 ✅ PR #338; PR-Z1 (doctrine bullets) ✅ PR #339; PR-A3a ✅ PR #_pending_ (AGENTS.md sweep deferred to follow-up post-B-series). Phase 1 underway per guardrails-first ordering.
...
| **A3a** | Grapher catalogue ADDITIVE (no deletes) | ✅ PR #_pending_ | Gregor |
