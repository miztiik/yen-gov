...
**Status**: ▶ ACTIVE — PR-A1 ✅ PR #336; PR-A2 ✅ PR #_pending_ (`--dry-run` flag threaded through writer + emit-taxonomy + lift-energy + lift-livestock + completeness-index). Phase 1 underway per guardrails-first ordering.
...
| **A2** | `--dry-run` flag | ✅ PR #_pending_ | Fowler |
