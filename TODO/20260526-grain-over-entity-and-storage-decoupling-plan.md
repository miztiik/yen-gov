...
| 28 | Livestock owner-reg district (parent + 6 size facets) | 7 ids | [L2594-L2765](../datasets/taxonomy/indicators.json#L2594) | merges into #29 | both | `holding_size ∈ {landless_marginal,small,semi_medium,medium,large,not_specified}` | B5 | ✅ DONE PR #_pending_ — collapsed with #29 |
| 29 | Livestock owner-reg state (mirror of #28) | 7 ids | [L2794-L2965](../datasets/taxonomy/indicators.json#L2794) | `livestock-owner-reg-count` | both | same | B5 | ✅ DONE PR #_pending_ — 14→7, entity_kinds=["district","state"] |
