...
| 26 | Pashu Aadhaar district (parent + 10 species) | collapsed with #27 | — | `pashu-aadhaar-count` | both | same | B5 | ✅ DONE PR #_pending_ — collapsed with #27 |
| 27 | Pashu Aadhaar state (parent + 10 species, mirror of #26) | 11 ids | — | `pashu-aadhaar-count` | both | same | B5 | ✅ DONE PR #_pending_ — 22→11, entity_kinds=["district","state"] |
