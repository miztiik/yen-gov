...
| 11 | Sectoral GVA current ↔ constant | `state_sectoral_gva_current_inr_lakh_crore`, `state_sectoral_gva_constant_2011_12_inr_lakh_crore` | (2 shards) | `sectoral-gva-inr-crore` | `state` | `basis ∈ {current,constant}`, sector | B6 | ✅ DONE PR #_pending_ |
