...
**Status**: ▶ ACTIVE — PR-A1 ✅ PR #336; PR-A2 ✅ PR #338; PR-Z1 (doctrine bullets) ✅ PR #339; PR-A3a ✅ PR #340; PR-A3b ✅ PR #341; PR-A3c (topic-half) ✅ PR #_pending_ (indicator-half + ingest-site tail deferred to follow-up PR-A3c-tail). Phase 1 underway per guardrails-first ordering.
