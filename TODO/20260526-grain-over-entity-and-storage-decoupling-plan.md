...
**Status**: ◻ READY — first PR (PR-A1) is unblocked and can start today.
...
#### PR-A1 — ADR-0044 (grain-over-entity) + ADR-0045 (grapher-catalogue split)
