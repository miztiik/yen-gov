...
>
> **T.0c-ii arc closed** — the original Phase-0-closeout plan `TODO/20260517-canonical-long-format-pivot.md §0e.10.4` `reference/in/states.json | DELETE | subsumed by entity_type='state' rows in taxonomy/entities.parquet | T.0c` row is now satisfied.
