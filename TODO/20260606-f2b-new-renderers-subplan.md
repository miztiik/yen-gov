...
| F2b.7 GeoChoropleth{symbol} mode extension + sandbox demo + section-13 smoke | F2b.3 | F2b.4, F2b.5, F2b.6 (file-disjoint - extends F2b.3 only) | vitest(centroid-by-feature, sqrt-area scale, glyph fallback) + section-13 in-browser smoke (sandbox) | _pending_ | IN-FLIGHT |
