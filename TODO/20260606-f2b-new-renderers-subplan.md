...
| F2b.4 Matrix renderer + sandbox demo + section-13 smoke | F2b.2 | F2b.3, F2b.5, F2b.6 | vitest(cell layout, color-scale share) + section-13 in-browser smoke (sandbox) | _pending_ | IN-FLIGHT |
