...
| PR-SYM-4a.i | DONE (pilot 4/40) | `frontend/public/party-symbols/{bjp-lotus,inc-hand,bsp-elephant,aap-broom}.svg`, `notes/20260601-party-symbol-pilot-batch.md` | none | sanitizer empirical pass (4/4) | unblocks PR-SYM-4a-rest | #_pending_ |
| PR-SYM-4a-rest | PENDING (~36 left) | remaining Tier 0 sanitized `frontend/public/party-symbols/*.svg`, `datasets/taxonomy/sources.parquet` rows iff Commons-direct | none | sanitizer vitest + Tier-A validate | PR-SYM-4b | _pending_ |
