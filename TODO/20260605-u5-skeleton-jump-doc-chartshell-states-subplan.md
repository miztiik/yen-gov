...
| U5b url.indicatorDoc + `/docs/indicator/:topic/:id` route + IndicatorDoc.svelte + tests | U5-spawn | U5a, U5c | build+vitest(url, indicator-doc)+in-browser smoke (`/docs/indicator/fiscal/outstanding_debt_pct_gsdp`) | _pending_ | IN-FLIGHT |
