...
| U5c IndicatorJump.svelte + StateOverview integration + tests | U5-spawn | U5a, U5b | build+vitest(indicator-jump)+in-browser smoke (`/s/tamil-nadu`) | _pending_ | IN-FLIGHT |
