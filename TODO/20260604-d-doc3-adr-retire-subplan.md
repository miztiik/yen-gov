...
| --- | --- | --- | --- | --- |
| D-DOC3.1 spawn (this PR; flip parent row + create this sub-plan) | - | docs-review | _pending_ | IN-FLIGHT |
...
Gate: grep-receipts-eq running total stays at 36 - the 8 ADRs being moved have 8 `Rejected alternatives` blocks (verified 6 of 8 carry the section; 0043, 0044 do not; net = 6 moved from decisions/ + 6 appended to subsystem docs = stable).
