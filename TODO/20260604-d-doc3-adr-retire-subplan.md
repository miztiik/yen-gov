...
| D-DOC3.8 fold backend / ingest / schema ADRs into `docs/architecture/backend/*` + `docs/architecture/data/schema-evolution.md` (LIVE: 0003, 0018, 0033, 0046, 0047-schema-version) | D-DOC3.2 | grep-receipts-eq | _pending_ | IN-FLIGHT |
