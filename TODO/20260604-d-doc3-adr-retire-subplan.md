...
| D-DOC3.6 fold url-grammar + place-IA + nav ADRs into `docs/concepts/url-grammar.md` (new if absent) + `docs/concepts/place-first-ia.md` (new if absent) + `docs/architecture/frontend/url-grammar.md` (LIVE: 0022, 0028, 0034, 0037, 0050; SUPERSEDED-archive: 0016-frontend-hash) | D-DOC3.2 | grep-receipts-eq | #732 | IN-FLIGHT |
