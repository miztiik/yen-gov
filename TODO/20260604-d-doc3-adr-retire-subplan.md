...
| D-DOC3.9 fold yenask + misc ADRs into `docs/architecture/frontend/yenask/*` + `docs/concepts/citizen-first.md` (LIVE: 0021, 0039, 0040; SUPERSEDED-archive: 0038; SUPERSEDED-archive: 0017-explore-page-uses-sql-js) | D-DOC3.2 | grep-receipts-eq | #730 | IN-FLIGHT |
