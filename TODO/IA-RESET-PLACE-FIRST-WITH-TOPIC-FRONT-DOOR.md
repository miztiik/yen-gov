...
**Status**: P1 + P2 + P2.5 + P3.1 + P3.2 + P3.3a + P3.3b + P3.3c + P3.3d complete (2026-05-13). Topic Front Door is live (`/t` and `/t/:topic`) with `?peer=…` deep-link state and breadcrumbs (P3.3d); LeftRail rewritten with grouped IA + StatePill (P3.3c). Validator green; vitest 9456/9456; svelte-check 0 errors (4 a11y warnings ignored per CLAUDE.md §0).
