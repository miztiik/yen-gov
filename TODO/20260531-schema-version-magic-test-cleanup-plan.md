...
**Status**: ACTIVE - Row A #501, Row B #503, Row C0 #506, Row C1 #507, Row C2 #509, Row C2.5 #511, Row C3 #512, Row D livestock slice #513, and Row G #514 merged; Row D ICED backend slice is in review as PR #515.
...
2026-05-31 ICED backend slice in review as PR #515 on `feat/iced-schema-version-emitter`:
