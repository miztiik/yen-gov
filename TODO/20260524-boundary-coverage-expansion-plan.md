...
**Last updated**: 2026-05-25 (after Phase A.1.b status-table reconcile: row was stale `In progress` despite PR #250 having merged at `9545336d` on 2026-05-25; no data change, table-only catch-up).
