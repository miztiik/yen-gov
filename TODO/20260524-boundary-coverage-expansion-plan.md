...
> **2026-05-25 update (D.6 closed KEEP-CURRENT)**: Recon-only PR landed. `tools/boundaries/recon_d6_pc.py` snapshotted the upstream archive and produced four structural NO-GO findings (full audit in `notes/2026-05-25-d6-pc-recon.md`):
>
