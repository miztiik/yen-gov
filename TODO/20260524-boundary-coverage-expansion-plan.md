...
**Last updated**: 2026-05-25 (after Phase D.1 — AC consolidation snapshot recon landed via PR #270 at `33d97800`: 10 states/UTs eligible for D.2 promote, S03 Assam + U08 J&K both Outcome 3 mixed so keep current, 19 keep-current, U09 Ladakh no-assembly; pipeline.json TBDs resolved to `AC_ID` + `ac_name`; recon tool `tools/boundaries/recon_d1_ac.py` deletable after D.5).
