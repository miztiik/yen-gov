...
**Status snapshot**: Phase A (pincode) complete (A.1.a + A.1.b + A.2 merged); Phase B (subdistrict national lift) in progress with PR open — 36 per-state subdistrict shards emit cleanly from upstream `LGD_Subdistricts.geojsonl`.
