...
> | D.5 | AC consolidation wrap-up (docs + ledger + ADR amend); ADR-0031 amendment 2026-05-25 records per-state authority table + S17 Article 371A empirical correction; `boundary-data-sources.md` three off-by-one fixes; one-shot `recon_d1_ac.py` retired; ledger verify-only | #_pending_ | `_pending_` |
>
