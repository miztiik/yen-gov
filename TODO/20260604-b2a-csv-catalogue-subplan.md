...
| --- | --- | --- | --- | --- |
| B2a.1 source.csv from `taxonomy/sources.parquet` (+ `derive_source_id` reused per CLAUDE.md section 12) | - | fk-validator | _pending_ | IN-FLIGHT |
| B2a.2 topics.csv from `taxonomy/topics.json` (parent-pointer flatten) | - | fk-validator | - | TODO |
