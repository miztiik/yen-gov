...
**Phase 2 (per-family ingestion)** is the active phase. Phase 1 + all infrastructure (T.1 / T.2 / T.3 / T.0d / T.0e / G.1 / S.1) ✅ DONE. **P.1 Energy ✅ DONE 2026-05-26** (P.1.A + P.1.B + P.1.C + P.1.D all closed; IA editorial pass + Tier-1 caveat-authoring shipped; family-level retirement audit + Tier-B scrub no-op-verified). P.2 Livestock-NDLM in progress on parallel branch (separate plan-doc). P.3+ families queued. Row 8 Citizen-1 panel ADR ⊘ DROPPED 2026-05-26 (too early). Row 12 Phase 4 SLM dispatcher ⊘ HANDED OFF 2026-05-26 to a separate SLM plan-doc.
