...
**Last Updated**: 2026-05-22 (Phase-2 pre-flight: PR1 `8de71a4a` shipped Tier-B forbid-new-folded-indicator-shards check; PR2 `3cb11036` shipped descope = T.1 status reconcile + features-KEEP doc + G.1 strangler-fig handover. G.1 now unpacks to 3 sub-PRs G.1.a/b/c per [`TODO/20260522-g1-cm-terms-retirement-handover.md`](20260522-g1-cm-terms-retirement-handover.md). Next: G.1.a entity-lift.)
