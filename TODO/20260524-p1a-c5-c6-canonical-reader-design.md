...
**Status**: ◻ DESIGN-OPEN. Authoring Q1–Q6 below. C5+C6 is the FINAL P.1.A step; ships as ONE fused-atomic commit per CLAUDE.md §15 + Holy Law #4. Blocks the ~16-shard energy-family retire-list scrub.
