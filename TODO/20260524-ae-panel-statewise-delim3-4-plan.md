...
**Status**: ACTIVE — tooling, Goa, Himachal Pradesh, Tripura, and Meghalaya PRs merged; Puducherry (`U07`) state PR in progress.
...
| 5 | Puducherry (`U07`) | State-only dry-run, event registration for missing `U07` rows, `DelimID=3` from 1977 onward and only missing `DelimID=4` event (`2011`) ingest, inventory/provenance/coverage updates. | ACTIVE — this PR |
