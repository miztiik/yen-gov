...
**Status**: ACTIVE — tooling through Mizoram (`S16`) merged; Nagaland (`S17`) state PR in progress.
...
| 16 | Nagaland (`S17`) | State-only dry-run, event registration for missing `S17` rows, scoped ingest from 1977 through 2013 to preserve existing 2018/2023 Section-10 slices and defer pre-1977 rows, inventory/provenance/coverage updates. | ACTIVE — this PR |
| 17+ | Remaining states | Proceed from small/low-risk states to medium states, then large/reorganisation-heavy states. | QUEUED |
...
- **Straight current-state queue**: Nagaland (`S17`, active), Delhi (`U05`), Haryana (`S07`), Kerala (`S11`), Punjab (`S19`), Rajasthan (`S20`), Karnataka (`S10`), Assam (`S03`), Odisha (`S18`), West Bengal (`S25`), Bihar (`S04`), Madhya Pradesh (`S12`), Uttar Pradesh (`S24`).
...
| 6 | `Nagaland` | `S17` | 2,482 | 1,543 | 939 | ACTIVE — verified in this PR |
