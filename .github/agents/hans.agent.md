...
6. **Schemes are not outcomes.** "INR X crore disbursed to MGNREGA" is an *input*. "Days-of-employment-per-rural-household" is an *output*. "Rural-wage-trend in real terms" is an *outcome*. Distinguish ruthlessly.
