...
| U2d closure (distil into `docs/architecture/frontend/design-system.md` U2 row; flip parent U2 ledger; archive this sub-plan) | U2a, U2b, U2c | - | docs-review | #747 | MERGED |
...
| U2d closure (archive + design-system.md U2 row + GeoBreadcrumb section + token-map additions + parent ledger flip) | #747 | this file under `docs/archive/plans/` + parent section 22.5 U2 row flipped to MERGED + [docs/architecture/frontend/design-system.md](../../architecture/frontend/design-system.md) per-component table U2 row flipped to MERGED + 4 token-map rows added + "U2 - GeoBreadcrumb + glass app bar + district URL node" section appended + drift-contract count updated 34 -> 38 |
