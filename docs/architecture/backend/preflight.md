...
This section consolidates the rationale (Context + Decision + Consequences, condensed) of the originating ADR that pinned the cross-cutting choice for this subsystem (the pre-flight gate contract); the originating ADR file was retired per [decision-index.md](../../reference/decision-index.md) and [docs/concepts/documentation-discipline.md#adr-0034-documentation-routing-contract](../../concepts/documentation-discipline.md#adr-0034-documentation-routing-contract). Folded into this doc per D-DOC3.8 (2026-06-04).
