...
| Indicators (per-shard JSON) | 96 | `datasets/indicators/in/<topic>/*.json` |
| **Total ledger rows** | **123** | |

Topic breakdown of the 96 indicators: demography 1, economy 20, energy 41, environment 8, fiscal 22, prices 4.
