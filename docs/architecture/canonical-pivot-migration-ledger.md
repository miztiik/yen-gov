...
| Indicators (per-shard JSON) | 94 | `datasets/indicators/in/<topic>/*.json` |
| **Total ledger rows** | **121** | |

Topic breakdown of the 94 indicators: demography 1, economy 18, energy 41, environment 8, fiscal 22, prices 4.
