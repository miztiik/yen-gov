...
| Indicators (per-shard JSON) | 95 | `datasets/indicators/in/<topic>/*.json` |
| **Total ledger rows** | **122** | |

Topic breakdown of the 95 indicators: demography 1, economy 19, energy 41, environment 8, fiscal 22, prices 4.
