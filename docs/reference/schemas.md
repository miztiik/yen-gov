...
Pulled from CLAUDE.md section 11 and [ADR-0047](../architecture/data/schema-evolution.md#adr-0047-schema-version-compatibility-contract) - re-stated here for convenience, but `CLAUDE.md` is authoritative if they ever conflict.
...
- [ADR-0047](../architecture/data/schema-evolution.md#adr-0047-schema-version-compatibility-contract) - schema-version compatibility decision.
