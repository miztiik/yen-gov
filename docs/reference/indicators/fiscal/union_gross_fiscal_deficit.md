...
> www.rbi.org.in, *Gross fiscal deficit (Union Government)*. Re-published by yen-gov as `fiscal/union_gross_fiscal_deficit`, schema v2.0. Retrieved 2026-05-14.

## Schema

`indicator.schema.json` v2.0 · artifact: [`datasets/indicators/in/fiscal/union_gross_fiscal_deficit.json`](../../../../datasets/indicators/in/fiscal/union_gross_fiscal_deficit.json)
