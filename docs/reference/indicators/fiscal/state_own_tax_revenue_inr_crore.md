...
> sansad.in, *States' own tax revenue*. Re-published by yen-gov as `fiscal/state_own_tax_revenue_inr_crore`, schema v4.0. Retrieved 2026-05-14.

## Schema

`indicator.schema.json` v4.0 · artifact: [`datasets/indicators/in/fiscal/state_own_tax_revenue_inr_crore.json`](../../../../datasets/indicators/in/fiscal/state_own_tax_revenue_inr_crore.json)
