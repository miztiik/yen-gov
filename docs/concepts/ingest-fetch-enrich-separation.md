...
- Vintage shifts use the `methodology_breaks.parquet` ledger per [ADR-0042](data-provenance.md#adr-0042-sources-schema-v3-vintage-as-period-anchor) — NEVER a new `indicator_id`.
