...
// Psephlab + Compare scenarios from `?s=<...>` (and `?a=` / `?b=` on
// the Compare surface). Per the election-experience-overhaul plan
// binding constraint #8 ("Ephemeral scenarios. No `?s=<b64>` URL. No
// localStorage. Refresh = fresh start."), the entire URL coupling
// retired in this PR alongside the Compare route deletion. The
// encode / decode pair had no remaining live consumers and was
// deleted too.
//
